...
SCRAPING = [
    ...
    },
    {
        ...
        {
        'directory': 'Stable Ischemic Heart Disease',
        'guideline_xml': 'e44.full.xml',
        'datasup_xml': 'media-1.xml',
        'cit_version': 2,
        'left_down': 53,
        'left_up': 70,
        'left_down_2': 107,
        ...
        {
        'directory': 'Valvular Heart Disease',
        'guideline_xml': 'e57.full.xml',
        'datasup_xml': '2014 VHD Guideline Data Supplements.xml',
        'cit_version': 2,
        'left_down': 40,
        'left_up': 60,
        'dsup_version': 4,
        ...
        'class_font':21,
            ...
            {
        'directory': 'Heart Failure',
        'guideline_xml': 'e147.full.xml',
        'datasup_xml': '2013_HFGL_Evidence_Tables.xml',
        'cit_version': 2,
        'left_down': 40,
        'left_up': 60,
        'dsup_version': 4,
